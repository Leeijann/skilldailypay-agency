...
export const YT_HEALTH_CORNER: BrandNiche = {
  ...
  niche: "Health tips, wellness, nutrition, fitness, mental health, natural remedies",
  topics: [
    "Foods that fight inflammation naturally",
    "Morning drinks that boost metabolism",
    "Signs your body is lacking key nutrients",
    "Simple exercises you can do at your desk",
    "Sleep habits that transform your health",
    "Superfoods you should eat every day",
    "Mental health tips backed by science",
    "Natural remedies your grandmother was right about",
    "The truth about intermittent fasting",
    "Stress relief techniques that work in 5 minutes",
  ],
  tone: "Informative, caring, evidence-based. Like a knowledgeable friend who cares about your health.",
  style: "Educational, clear explanations, backed by facts. No fear-mongering.",
  hashtags: ["#healthcorner", "#health", "#wellness", "#nutrition", "#fitness", "#healthtips", "#naturalhealth", "#selfcare"],
  platforms: [
    { platform: "youtube", accountId: "33404", accountName: "The Health Corner", format: "Compelling title + 200 word description + 5 tags, health angle" },
  ],
};
